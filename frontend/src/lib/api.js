...
export const fetchOverview = (params = {}) => api.get('/api/analytics/overview', { params }).then(res => res.data);
...
export const fetchApplications = (params = {}) => api.get('/api/analytics/applications', { params }).then(res => res.data);
